...
- This repository owns only engine interoperability and conformance-harness projections; shared protocols, runtime behavior, evidence schemas, and capability authority remain in the engine.
